...
<html>
	<head>
		<title>RajinCopas.Com  Pemrograman & Source Code</title>
		<meta charset="utf-8" />
			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro">
						...
						<p>Website ini dibuat oleh seseorang mahasiswa yang mempunyai tangan ajaib <a href="#">@yosep_al93</a><br />
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo">Rajin Copas Blog</a>
					</header>
				...
				<!-- Main -->
					...
					<!-- Copyright -->
					<div id="copyright">
					    <ul><li>&copy; RajinCopas</li><li>Design: <a href="http://rajincopas.my.id/contact">Yosep alfatah</a></li></ul>
					</div>
